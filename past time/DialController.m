...
#warning this implementation does not like duplicate strings. each string in the values of the dial has to be different that the others
        ...
        self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width, 220) style:UITableViewStylePlain];
...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        cell = [[UITableViewCell alloc] initWithFrame:CGRectMake(0, 0, self.tableView.frame.size.width, self.tableView.rowHeight) reuseIdentifier:CellIdentifier];
        ...
        bgLabel.textColor = [UIColor clearColor];
